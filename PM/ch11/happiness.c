 ...
 * File:happiness.c
 * ----------------
 * This program asks the yser their state of happiness on a scale 
...
int main()  {
    ...
    * statements test the number against decreasing numbers. Only one
   ...
   if  (prefer >= 8)  {
      ...
      printf("Sorry your're feeling not so great.\n");
